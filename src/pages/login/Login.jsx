...
const Login = () => {
  ...
  // const handleLogin = () => {
  //   // Implement login logic here using email and password states
          ...
          <div className="col-12 col-md-8 col-lg-6 col-xl-5">
            <div className="card shadow-2-strong" style={{ borderRadius: '1rem' }}>
              <div className="card-body p-5 text-center">
                ...
                <button className="btn btn-primary btn-lg btn-block" type="submit" onClick={() => navigate('/dash')}>Click to view Dashboard!!!!</button>
              ...
              <div style={{ justifyContent: "space-between" }}>
                  <p className="link">You have an account?
                    <Link to={'/signup'} style={{textAlign:"end"}}>SignUp</Link></p>
